...
//------------------------------------------------------------------------
//
//  this is implemented as a state blip. The miner invite and drink with Josh
//  And then returns to his previous state
//------------------------------------------------------------------------
class DrinkWithJosh : public State<Miner>
{
private:
	...
	//copy ctor and assignment should be private
	DrinkWithJosh(const DrinkWithJosh&);
	DrinkWithJosh& operator=(const DrinkWithJosh&);
